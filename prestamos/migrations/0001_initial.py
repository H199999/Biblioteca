...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Default Editor Name', max_length=50, verbose_name='Editor')),
            ],
        ),
        migrations.CreateModel(
            name='Renovacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('trabajador', 'Trabajador')], default='trabajador', max_length=20, verbose_name='Rol')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('rol', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='prestamos.rol', verbose_name='Rol')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='prestamos.editor', verbose_name='Editor')),
            ],
        ),
        migrations.CreateModel(
            name='Multa',
